      ...
      <div class="px-2 sm:px-4 md:px-10 mx-5 md:flex">
        <div class="block sm:flex md:block rounded overflow-hidden shadow-lg bg-[#061357] md:mx-5 md:pb-20 my-10 md:my-2 items-center">
         ...
         <img src="./images/man.png" alt="img" className='h-auto md:h-[200px] mx-auto mt-10 mb-10 md:mt-20 pl-5 md:pl-0'/>
          ...
          <div class="md:px-6 py-4 text-center sm:text-left md:text-center w-[90%] lg:w-[80%] mx-auto">
            <div class="font-bold text-2xl lg:text-3xl my-5 text-white"> Internship portal </div>
            <p class="text-[17px] text-white pr-2 md:pr-0">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Enim volutpat, urna auctor sed.
            </p>
            <div class="md:px-6 py-10 text-center sm:text-left md:text-center">
            <span class="text-center inline-block rounded-md px-6 py-3 text-md md:text-lg font-semibold bg-[#7443DE] text-white mb-2 w-[170px] lg:w-[200px]">
            Get internship
            </span> 
          </div>
          </div>
        ...
        <div class="block sm:flex md:block rounded overflow-hidden shadow-lg bg-[#061357] md:mx-5 md:pb-20 my-10 md:my-2 items-center">
         ...
         <img src="./images/job.png" alt="img" className='h-auto md:h-[200px] mx-auto mt-10 mb-10 md:mt-20 pl-5 md:pl-0'/>
          ...
          <div class="md:px-6 py-4 text-center sm:text-left md:text-center w-[90%] lg:w-[80%] mx-auto">
            ...
            <p class="text-white text-[17px] pr-2 md:pr-0">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Enim volutpat, urna auctor sed.
            </p>
            <div class="md:px-6 py-10 text-center sm:text-left md:text-center">
            <span class="text-center inline-block rounded-md px-6 py-3 text-md md:text-lg font-semibold bg-[#7443DE] text-white mb-2 w-[170px] lg:w-[200px]">
